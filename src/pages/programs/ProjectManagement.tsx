                ...
                <div className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="aspect-video">
                    <iframe 
                      ...
                      title="مقدمة عن برنامج إدارة المشاريع"
                      frameBorder="0"
                  ...
                  <div className="p-6">
                    <h4 className="font-semibold text-card-foreground mb-3 text-lg">
                      {isRTL ? 'مقدمة عن برنامج إدارة المشاريع' : 'Introduction to Project Management Program'}
                    </h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {isRTL ? 'اكتشف كيف يؤهل برنامج إدارة المشاريع الطلاب لقيادة المشاريع الكبرى بكفاءة عالية.' : 'Discover how the Project Management program prepares students to lead major projects with high efficiency.'}
                    </p>
                  </div>
                </div>
                <div className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="aspect-video">
                    <iframe 
                      src="https://www.youtube.com/embed/dQw4w9WgXcQ"
                      title="تجربة طلاب إدارة المشاريع"
                      frameBorder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                      allowFullScreen
                      className="w-full h-full"
                  ...
                  <div className="p-6">
                    <h4 className="font-semibold text-card-foreground mb-3 text-lg">
                      {isRTL ? 'تجربة طلاب إدارة المشاريع' : 'Project Management Students Experience'}
                    </h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {isRTL ? 'تعرف على تجارب طلابنا في تطبيق منهجيات إدارة المشاريع المعتمدة دولياً.' : 'Learn about our students\' experiences in applying internationally certified project management methodologies.'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50/50 to-green-100/30 dark:from-green-950/30 dark:to-green-900/20 rounded-3xl p-8 mb-8 border border-green-200/50 dark:border-green-800/30 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="aspect-square bg-muted rounded-xl overflow-hidden group cursor-pointer">
                  <img src="/images/project-management.jpg" alt={isRTL ? 'فعاليات برنامج إدارة المشاريع' : 'Project Management Program Activities'} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="aspect-square bg-muted rounded-xl overflow-hidden group cursor-pointer">
              ...
              <div className="space-y-6">
                <article className="bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                    ...
                    <time dateTime="2024-01-22">22 يناير 2024</time>
                  </div>
                  <h4 className="text-lg font-semibold text-card-foreground mb-3">
                    {isRTL ? 'شهادة PMP معتمدة للخريجين' : 'Certified PMP Certification for Graduates'}
                  </h4>
                  <p className="text-muted-foreground leading-relaxed">
                    {isRTL ? 'حصل عدد من خريجي برنامج إدارة المشاريع على شهادة PMP المعتمدة دولياً، مما يعزز فرصهم في سوق العمل.' : 'Several graduates of the Project Management program obtained the internationally certified PMP certification, enhancing their opportunities in the job market.'}
                  </p>
                </article>
                <article className="bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                    ...
                    <time dateTime="2024-01-16">16 يناير 2024</time>
                  </div>
                  <h4 className="text-lg font-semibold text-card-foreground mb-3">
                    {isRTL ? 'ورشة منهجيات أجايل' : 'Agile Methodologies Workshop'}
                  </h4>
                  <p className="text-muted-foreground leading-relaxed">
                    {isRTL ? 'استضاف البرنامج ورشة تدريبية حول منهجيات أجايل في إدارة المشاريع بقيادة خبراء من الشركات التقنية الرائدة.' : 'The program hosted a training workshop on Agile methodologies in project management led by experts from leading technology companies.'}
                  </p>
                </article>
              </div>
            </div>
