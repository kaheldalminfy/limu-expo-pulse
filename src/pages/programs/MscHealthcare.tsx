                ...
                <div className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="aspect-video">
                    <iframe 
                      ...
                      title="مقدمة عن برنامج ماجستير إدارة الرعاية الصحية"
                      frameBorder="0"
                  ...
                  <div className="p-6">
                    <h4 className="font-semibold text-card-foreground mb-3 text-lg">
                      {isRTL ? 'مقدمة عن برنامج ماجستير إدارة الرعاية الصحية' : 'Introduction to Master in Healthcare Management Program'}
                    </h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {isRTL ? 'استكشف برنامج الماجستير المتقدم في إدارة الأنظمة الصحية ومنهجيته الأكاديمية المتميزة.' : 'Explore the advanced Master\'s program in healthcare systems management and its distinguished academic methodology.'}
                    </p>
                  </div>
                </div>
                <div className="group bg-white/70 dark:bg-gray-800/70 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-6">
                    <h4 className="font-semibold text-card-foreground mb-3 text-lg">
                      {isRTL ? 'تجربة طلاب الماجستير' : 'Master\'s Students Experience'}
                    </h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {isRTL ? 'تعرف على تجارب طلاب الماجستير وكيف يطبقون البحث العلمي في حل مشكلات الأنظمة الصحية.' : 'Learn about Master\'s students\' experiences and how they apply scientific research to solve healthcare systems problems.'}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-50/50 to-green-100/30 dark:from-green-950/30 dark:to-green-900/20 rounded-3xl p-8 mb-8 border border-green-200/50 dark:border-green-800/30 backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="aspect-square bg-muted rounded-xl overflow-hidden group cursor-pointer">
                  <img src="/images/msc-healthcare.jpg" alt={isRTL ? 'فعاليات برنامج ماجستير إدارة الرعاية الصحية' : 'Master in Healthcare Management Program Activities'} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="aspect-square bg-muted rounded-xl overflow-hidden group cursor-pointer">
              ...
              <div className="space-y-6">
                <article className="bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                    ...
                    <time dateTime="2024-01-30">30 يناير 2024</time>
                  </div>
                  <h4 className="text-lg font-semibold text-card-foreground mb-3">
                    {isRTL ? 'مؤتمر الأنظمة الصحية المستدامة' : 'Sustainable Healthcare Systems Conference'}
                  </h4>
                  <p className="text-muted-foreground leading-relaxed">
                    {isRTL ? 'استضاف برنامج الماجستير مؤتمراً دولياً حول الأنظمة الصحية المستدامة بمشاركة خبراء من منظمة الصحة العالمية.' : 'The Master\'s program hosted an international conference on sustainable healthcare systems with experts from the World Health Organization.'}
                  </p>
                </article>
                <article className="bg-white/60 dark:bg-gray-800/60 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-3">
                  ...
                  <h4 className="text-lg font-semibold text-card-foreground mb-3">
                    {isRTL ? 'نشر بحث في مجلة دولية' : 'Research Published in International Journal'}
                  </h4>
                  <p className="text-muted-foreground leading-relaxed">
                    {isRTL ? 'نجح طلاب الماجستير في نشر بحث حول تطوير الأنظمة الصحية الليبية في مجلة دولية محكمة.' : 'Master\'s students succeeded in publishing research on developing Libyan healthcare systems in a peer-reviewed international journal.'}
                  </p>
                </article>
              </div>
            </div>
